...
| Path               | Purpose                                                       |
| :----------------- | :------------------------------------------------------------ |
| `src/main.js`      | The heart: handles the camera, mouse, and rendering loop.     |
| `src/knowledge.js` | The memory: contains the static knowledge base (the "Brain"). |
| `src/gemini.js`    | The soul: connects to the AI to generate new nodes.           |
| `src/style.css`    | The skin: beautiful Glassmorphism and UI animations.          |
| `public/`          | Home for images and static assets.                            |
